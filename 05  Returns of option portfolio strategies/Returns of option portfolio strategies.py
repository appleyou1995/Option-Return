...
Path_Output = os.path.join(Path_dir, 'Code/05  Returns of option portfolio strategies/')
...
CV = pd.read_csv(os.path.join(Path_Input, '控制變數', 'Characteristics_Sub_var.csv'))
...
Control_Variable_List = pd.Index(CV.columns[13:23].tolist())
